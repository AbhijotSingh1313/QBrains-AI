...
function initImageExports(displayed) {
    ...
    exportJpgButton.addEventListener('click', () => {
        ...
        downloadLink.download = 'quantum-circuit.jpg';
        downloadLink.click();
    });
    ...
    exportPngButton.addEventListener('click', () => {
        ...
        const downloadLink = document.createElement('a');
        downloadLink.href = imageURL;
        downloadLink.download = 'quantum-circuit.png';
        downloadLink.click();
    });
    ...
    exportWebpButton.addEventListener('click', () => {
        ...
        const downloadLink = document.createElement('a');
        downloadLink.href = imageURL;
        downloadLink.download = 'quantum-circuit.webp';
        downloadLink.click();
    });
    ...
    exportSvgButton.addEventListener('click', () => {
        ...
        downloadLink.download = 'quantum-circuit.svg';
        downloadLink.click();
    });
