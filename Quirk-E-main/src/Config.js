...
Config.EMPTY_CIRCUIT_TITLE = 'Quantum Learning Platform';
...
// Toolbox layout.
Config.BACKGROUND_COLOR_TOOLBOX = '#f1f5f9';
...
Config.DEFAULT_FONT_FAMILY = 'Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif';
...
Config.DARK_BG = '#1e222b';
Config.DARK_BG_CIRCUIT = '#1e222b';
Config.DARK_BG_TOOLBOX = '#171b23';
Config.RED = '#762020';
