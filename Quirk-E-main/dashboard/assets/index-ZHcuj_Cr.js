...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fo(e,t,n){return new ea({name:`SphericalGaussianBlur`,defines:{SAMPLES:bo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Ro(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Io(){return new ea({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ro(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Lo(){return new ea({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ro(),fragmentShader:`
	...
	`}var zo=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ui(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var uc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function dc(e,t){let n=uc[t];return n===void 0?(H(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var fc=new K;function pc(){return J.getLuminanceCoefficients(fc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${fc.x.toFixed(4)}, ${fc.y.toFixed(4)}, ${fc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `})]})}function Au({openModal:e}){let[t,n]=(0,_.useState)(null);return(0,Q.jsxs)(`section`,{style:{position:`relative`,zIndex:10,minHeight:`100vh`,display:`flex`,flexDirection:`column`,justifyContent:`center`,alignItems:`center`,padding:`130px 24px 60px`,textAlign:`center`,overflow:`hidden`},children:[(0,Q.jsxs)(`div`,{className:`anim-bg-elements`,style:{position:`absolute`,inset:0,pointerEvents:`none`,zIndex:0,overflow:`hidden`},children:[(0,Q.jsxs)(`div`,{className:`animate-float`,style:{position:`absolute`,left:`4%`,top:`32%`,display:`flex`,flexDirection:`column`,gap:`14px`,opacity:.42},children:[(0,Q.jsx)(`div`,{style:{padding:`7px 14px`,borderRadius:`10px`,background:`rgba(24, 13, 48, 0.5)`,border:`1px solid rgba(168, 85, 247, 0.25)`,fontFamily:`var(--font-mono)`,fontSize:`0.78rem`,color:`var(--accent-cyan)`,letterSpacing:`0.04em`,boxShadow:`0 4px 16px rgba(0,0,0,0.3)`},children:`|ψ⟩ = α|0⟩ + β|1⟩`}),(0,Q.jsxs)(`div`,{style:{padding:`5px 12px`,borderRadius:`8px`,background:`rgba(24, 13, 48, 0.35)`,border:`1px solid rgba(168, 85, 247, 0.16)`,fontFamily:`var(--font-mono)`,fontSize:`0.7rem`,color:`var(--text-muted)`,display:`flex`,alignItems:`center`,gap:`6px`},children:[(0,Q.jsx)(`span`,{style:{width:`5px`,height:`5px`,borderRadius:`50%`,background:`var(--accent-cyan)`}}),(0,Q.jsx)(`span`,{children:`Hadamard: H ─ • ─`})]})]}),(0,Q.jsxs)(`div`,{className:`animate-float`,style:{position:`absolute`,right:`4%`,top:`34%`,display:`flex`,flexDirection:`column`,gap:`14px`,opacity:.42,animationDelay:`2.5s`},children:[(0,Q.jsx)(`div`,{style:{padding:`7px 14px`,borderRadius:`10px`,background:`rgba(24, 13, 48, 0.5)`,border:`1px solid rgba(168, 85, 247, 0.25)`,fontFamily:`var(--font-mono)`,fontSize:`0.78rem`,color:`var(--accent-purple)`,letterSpacing:`0.04em`,boxShadow:`0 4px 16px rgba(0,0,0,0.3)`},children:`U(θ, φ, λ) • Unitary`}),(0,Q.jsxs)(`div`,{style:{padding:`5px 12px`,borderRadius:`8px`,background:`rgba(24, 13, 48, 0.35)`,border:`1px solid rgba(168, 85, 247, 0.16)`,fontFamily:`var(--font-mono)`,fontSize:`0.7rem`,color:`var(--text-muted)`,display:`flex`,alignItems:`center`,gap:`6px`},children:[(0,Q.jsx)(`span`,{style:{width:`5px`,height:`5px`,borderRadius:`50%`,background:`var(--accent-purple)`}}),(0,Q.jsx)(`span`,{children:`Bell State: |Φ⁺⟩`})]})]})]}),(0,Q.jsxs)(`div`,{className:`quantum-pill animate-float anim-pill-entrance`,style:{marginBottom:`26px`,cursor:`pointer`,padding:`8px 18px`,position:`relative`,zIndex:3},onClick:()=>e(`learning`),children:[(0,Q.jsx)(bu,{size:16,style:{color:`var(--accent-cyan)`}}),(0,Q.jsx)(`span`,{children:`Quantum AI Architecture 2.0 • Interactive QPU Simulators`}),(0,Q.jsx)(Bl,{size:14})]}),(0,Q.jsxs)(`div`,{className:`hero-center-shield anim-hero-shield`,style:{marginBottom:`44px`},children:[(0,Q.jsxs)(`h1`,{className:`hero-title-text`,style:{fontSize:`clamp(2.4rem, 5.5vw, 4.6rem)`,fontWeight:900,lineHeight:1.1,letterSpacing:`-0.03em`,marginBottom:`26px`,textTransform:`uppercase`},children:[`AI-Based Interactive `,(0,Q.jsx)(`br`,{}),(0,Q.jsx)(`span`,{className:`gradient-text`,children:`Quantum Algorithm`}),(0,Q.jsx)(`br`,{}),(0,Q.jsx)(`span`,{style:{fontSize:`clamp(2rem, 4.5vw, 3.8rem)`,fontWeight:800,letterSpacing:`0.01em`,color:`var(--text-primary)`,opacity:.95},children:`Learning Platform`})]}),(0,Q.jsxs)(`div`,{className:`anim-hero-buttons`,style:{display:`flex`,flexWrap:`wrap`,justifyContent:`center`,alignItems:`center`,gap:`16px`},children:[(0,Q.jsxs)(`button`,{onClick:()=>{window.location.href=`/simulator/index.html`},className:`btn-primary`,style:{padding:`14px 28px`,fontSize:`1.02rem`,borderRadius:`12px`},children:[(0,Q.jsx)(nu,{size:18}),(0,Q.jsx)(`span`,{children:`Launch Circuit Composer`})]}),(0,Q.jsxs)(`button`,{onClick:()=>e(`simulation`),className:`btn-secondary`,style:{padding:`14px 26px`,fontSize:`1.02rem`,borderRadius:`12px`},children:[(0,Q.jsx)(Ql,{size:18}),(0,Q.jsx)(`span`,{children:`3D Bloch Simulation`})]}),(0,Q.jsxs)(`button`,{onClick:()=>e(`tutor`),className:`btn-secondary`,style:{padding:`14px 26px`,fontSize:`1.02rem`,borderRadius:`12px`,borderColor:`rgba(168, 85, 247, 0.4)`,color:`var(--accent-purple)`},children:[(0,Q.jsx)(bu,{size:18}),(0,Q.jsx)(`span`,{children:`Consult AI Tutor`})]})]})]}),(0,Q.jsxs)(`div`,{className:`glass-panel`,style:{width:`100%`,maxWidth:`1120px`,margin:`0 auto`,padding:`24px 32px`,display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(320px, 1fr))`,gap:`32px`,alignItems:`center`,textAlign:`left`,borderRadius:`20px`},children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsxs)(`div`,{className:`quantum-pill-gold quantum-pill`,style:{marginBottom:`12px`},children:[(0,Q.jsx)(Ou,{size:14}),` Rigetti Novera™ Superconducting QPU`]}),(0,Q.jsx)(`h3`,{style:{fontSize:`1.6rem`,fontWeight:800,marginBottom:`10px`},children:`Real Quantum Hardware Architecture`}),(0,Q.jsx)(`p`,{style:{fontSize:`0.92rem`,color:`var(--text-secondary)`,lineHeight:1.6,marginBottom:`18px`},children:`Every simulation runs against calibrated noise models from commercial superconducting dilution cryostats. Inspect the sub-kelvin microwave control array and quantum chip brackets below.`}),(0,Q.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`8px`},children:[{id:`coax`,top:`18%`,left:`50%`,title:`Cryogenic Coaxial RF Wiring`,desc:`Superconducting niobium-titanium coaxial lines feeding microwave control pulses at 4-8 GHz.`},{id:`plates`,top:`42%`,left:`70%`,title:`Gold-Plated Copper Thermal Flange`,desc:`Isolates electromagnetic radiation and maintains millikelvin thermal conductivity.`},{id:`qpu`,top:`84%`,left:`50%`,title:`Transmon Qubit Core (10 mK)`,desc:`Josephson junction-based superconducting qubits suspended at near absolute zero temperature.`}].map(e=>(0,Q.jsxs)(`div`,{onMouseEnter:()=>n(e.id),onMouseLeave:()=>n(null),style:{padding:`10px 14px`,borderRadius:`10px`,background:t===e.id?`rgba(168, 85, 247, 0.15)`:`var(--bg-glass)`,border:`1px solid ${t===e.id?`var(--accent-cyan)`:`var(--border-subtle)`}`,cursor:`pointer`,transition:`var(--transition-smooth)`},children:[(0,Q.jsx)(`div`,{style:{fontSize:`0.88rem`,fontWeight:700,color:`var(--text-bright)`},children:e.title}),(0,Q.jsx)(`div`,{style:{fontSize:`0.78rem`,color:`var(--text-muted)`},children:e.desc})]},e.id))})]}),(0,Q.jsxs)(`div`,{style:{position:`relative`,borderRadius:`16px`,overflow:`hidden`,border:`1px solid var(--border-glass)`,background:`linear-gradient(180deg, rgba(0,0,0,0.4) 0%, rgba(0,0,0,0.7) 100%)`,display:`flex`,alignItems:`center`,justifyContent:`center`,padding:`20px`,boxShadow:`0 12px 40px rgba(0,0,0,0.4)`},children:[(0,Q.jsx)(`img`,{src:`/quantum-processor.jpg`,alt:`Rigetti Novera Quantum Processor`,style:{maxHeight:`380px`,width:`auto`,objectFit:`contain`,filter:`drop-shadow(0 0 25px rgba(245, 158, 11, 0.4))`,transition:`transform 0.5s ease`},className:`animate-float`}),(0,Q.jsxs)(`div`,{style:{position:`absolute`,bottom:`16px`,left:`16px`,right:`16px`,padding:`10px 14px`,borderRadius:`10px`,background:`rgba(5, 8, 17, 0.75)`,backdropFilter:`blur(10px)`,border:`1px solid var(--border-glass)`,display:`flex`,alignItems:`center`,justifyContent:`space-between`},children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`8px`},children:[(0,Q.jsx)(`span`,{style:{width:`8px`,height:`8px`,borderRadius:`50%`,background:`var(--accent-emerald)`,boxShadow:`0 0 8px var(--accent-emerald)`}}),(0,Q.jsx)(`span`,{style:{fontSize:`0.8rem`,fontWeight:600,fontFamily:`var(--font-mono)`},children:`NOVERA 9Q CHIP CALIBRATED`})]}),(0,Q.jsxs)(`button`,{onClick:()=>e(`simulation`),style:{fontSize:`0.75rem`,color:`var(--accent-cyan)`,fontWeight:600,display:`flex`,alignItems:`center`,gap:`4px`},children:[`Test Qubits `,(0,Q.jsx)(Jl,{size:14})]})]})]})]})]})}function ju({openModal:e}){return(0,Q.jsxs)(`section`,{style:{position:`relative`,zIndex:10,maxWidth:`1280px`,margin:`0 auto`,padding:`60px 24px 80px`},children:[(0,Q.jsxs)(`div`,{style:{textAlign:`center`,marginBottom:`40px`},children:[(0,Q.jsxs)(`div`,{className:`quantum-pill`,style:{marginBottom:`10px`},children:[(0,Q.jsx)(Ou,{size:14}),` Core Quantum Algorithms`]}),(0,Q.jsx)(`h2`,{style:{fontSize:`clamp(2rem, 3.5vw, 2.8rem)`,fontWeight:800},children:`Interactive Algorithm Benchmarks`}),(0,Q.jsx)(`p`,{style:{color:`var(--text-secondary)`,maxWidth:`650px`,margin:`8px auto 0`,fontSize:`0.98rem`},children:`Execute classical vs. quantum complexity benchmarks. Transpile code straight into real QPU gates.`})]}),(0,Q.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(280px, 1fr))`,gap:`20px`},children:[{id:`grover`,name:`Grover's Search`,category:`Database & Search`,speedup:`Quadratic Speedup (√N)`,complexity:`O(√N)`,description:`Quantum search in unsorted databases with optimal amplitude amplification and phase inversion.`,icon:gu,tagColor:`var(--accent-cyan)`,actionTab:`composer`},{id:`shor`,name:`Shor's Factorization`,category:`Cryptography & Number Theory`,speedup:`Exponential Speedup`,complexity:`O((log N)³)`,description:`Finds prime factors of integers via Quantum Fourier Transform, challenging RSA-2048 encryption.`,icon:iu,tagColor:`var(--accent-gold)`,actionTab:`simulation`},{id:`vqe`,name:`Variational Quantum Eigensolver (VQE)`,category:`Quantum Chemistry & Materials`,speedup:`NISQ-Era Hybrid Optimization`,complexity:`O(poly(N))`,description:`Calculates ground state molecular energy of lithium hydride (LiH) and complex catalysts.`,icon:eu,tagColor:`var(--accent-emerald)`,actionTab:`learning`},{id:`qnn`,name:`Quantum Neural Networks (QNN)`,category:`Quantum Artificial Intelligence`,speedup:`High-Dimensional Feature Spaces`,complexity:`Parameterized Quantum Circuits`,description:`Embeds classical tensors into Hilbert space via quantum kernels for exponential classification.`,icon:Kl,tagColor:`var(--accent-purple)`,actionTab:`tutor`}].map(t=>{let n=t.icon;return(0,Q.jsxs)(`div`,{className:`glass-panel-glow`,style:{padding:`24px`,display:`flex`,flexDirection:`column`,justifyContent:`space-between`,borderRadius:`16px`},children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`flex-start`,marginBottom:`16px`},children:[(0,Q.jsx)(`div`,{style:{width:`46px`,height:`46px`,borderRadius:`12px`,background:`rgba(255, 255, 255, 0.05)`,border:`1px solid var(--border-glass)`,display:`flex`,alignItems:`center`,justifyContent:`center`,color:t.tagColor},children:(0,Q.jsx)(n,{size:22})}),(0,Q.jsx)(`span`,{style:{fontSize:`0.72rem`,fontFamily:`var(--font-mono)`,padding:`3px 8px`,borderRadius:`6px`,background:`rgba(255, 255, 255, 0.06)`,color:t.tagColor,border:`1px solid ${t.tagColor}44`},children:t.complexity})]}),(0,Q.jsx)(`div`,{style:{fontSize:`0.75rem`,textTransform:`uppercase`,letterSpacing:`0.05em`,color:`var(--text-muted)`,marginBottom:`4px`},children:t.category}),(0,Q.jsx)(`h3`,{style:{fontSize:`1.25rem`,fontWeight:700,marginBottom:`8px`},children:t.name}),(0,Q.jsx)(`p`,{style:{fontSize:`0.88rem`,color:`var(--text-secondary)`,lineHeight:1.5,marginBottom:`16px`},children:t.description})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsxs)(`div`,{style:{fontSize:`0.8rem`,fontWeight:600,color:`var(--text-primary)`,marginBottom:`12px`,display:`flex`,alignItems:`center`,gap:`6px`},children:[(0,Q.jsx)(`span`,{style:{color:`var(--accent-emerald)`},children:`⚡`}),(0,Q.jsx)(`span`,{children:t.speedup})]}),(0,Q.jsxs)(`button`,{onClick:()=>e(t.actionTab),className:`btn-secondary`,style:{width:`100%`,padding:`10px`,fontSize:`0.85rem`,justifyContent:`space-between`},children:[(0,Q.jsx)(`span`,{children:`Explore Circuit`}),(0,Q.jsx)(Bl,{size:15})]})]})]},t.id)})})]})}function Mu({type:e,onClose:t,onNavigate:n}){return e?(0,Q.jsx)(`div`,{className:`modal-overlay`,onClick:t,children:(0,Q.jsxs)(`div`,{className:`glass-panel-glow`,onClick:e=>e.stopPropagation(),style:{width:`100%`,maxWidth:e===`signin`||e===`signup`?`460px`:`920px`,maxHeight:`90vh`,overflowY:`auto`,padding:`28px`,position:`relative`,border:`1px solid var(--border-glass-strong)`,boxShadow:`0 20px 60px rgba(0, 0, 0, 0.5)`},children:[(0,Q.jsx)(`button`,{onClick:t,className:`btn-icon`,style:{position:`absolute`,top:`20px`,right:`20px`,width:`36px`,height:`36px`},"aria-label":`Close dialog`,children:(0,Q.jsx)(Eu,{size:18})}),e===`learning`&&(0,Q.jsx)(Nu,{onNavigate:n}),e===`simulation`&&(0,Q.jsx)(Pu,{}),e===`composer`&&(0,Q.jsx)(Fu,{}),e===`tutor`&&(0,Q.jsx)(Iu,{}),e===`assessment`&&(0,Q.jsx)(Lu,{}),(e===`signin`||e===`signup`)&&(0,Q.jsx)(Ru,{initialMode:e,onClose:t})]})}):null}function Nu({onNavigate:e}){let[t,n]=(0,_.useState)(0),r=[{title:`Module 1: Foundations of Quantum Bits`,level:`Beginner`,duration:`45 mins`,progress:75,description:`Understand superposition, classical vs. quantum states, Dirac bra-ket notation, and statevectors.`,concepts:[`Statevector Representation`,`Bloch Sphere Coordinates`,`Probability Amplitudes`,`Quantum Measurement Collapse`],formula:`|\\psi\\rangle = \\alpha|0\\rangle + \\beta|1\\rangle \\quad \\text{where } |\\alpha|^2 + |\\beta|^2 = 1`},{title:`Module 2: Quantum Gates & Multi-Qubit Systems`,level:`Intermediate`,duration:`1.2 hrs`,progress:40,description:`Single-qubit unitary matrices (X, Y, Z, H, S, T) and two-qubit entanglement generators (CNOT, CZ, SWAP).`,concepts:[`Unitary Matrix Operators`,`Bell States & Entanglement`,`No-Cloning Theorem`,`Phase Kickback`],formula:`|\\Phi^+\\rangle = \\frac{1}{\\sqrt{2}}(|00\\rangle + |11\\rangle)`},{title:`Module 3: Quantum Fourier Transform (QFT)`,level:`Advanced`,duration:`2.5 hrs`,progress:10,description:`The computational core behind Shor’s factoring algorithm and quantum phase estimation.`,concepts:[`Discrete Phase Rotation`,`Controlled-Phase Gates`,`Frequency Domain Mapping`,`Period Finding`],formula:`QFT|j\\rangle = \\frac{1}{\\sqrt{N}} \\sum_{k=0}^{N-1} \\omega^{jk} |k\\rangle`},{title:`Module 4: Grover’s Quantum Search Algorithm`,level:`Advanced`,duration:`2.0 hrs`,progress:0,description:`Achieve quadratic speedup $O(\\sqrt{N})$ for unstructured database search using amplitude amplification.`,concepts:[`Oracle Function Design`,`Diffusion Operator (Inversion about mean)`,`Geometric State Rotation`,`Decoherence Mitigation`],formula:`G = (2|s\\rangle\\langle s| - I) \\cdot O_f`}],i=r[t];return(0,Q.jsxs)(`div`,{children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`10px`,marginBottom:`8px`},children:[(0,Q.jsxs)(`div`,{className:`quantum-pill`,children:[(0,Q.jsx)(Wl,{size:14}),` Interactive Curriculum`]}),(0,Q.jsx)(`span`,{style:{fontSize:`0.8rem`,color:`var(--text-muted)`},children:`AI-Guided Pathway`})]}),(0,Q.jsx)(`h2`,{style:{fontSize:`1.8rem`,fontWeight:800,marginBottom:`6px`},children:`Quantum Computing & Algorithm Mastery`}),(0,Q.jsx)(`p`,{style:{color:`var(--text-secondary)`,marginBottom:`24px`,fontSize:`0.95rem`},children:`Interactive step-by-step masterclasses engineered for both quantum beginners and algorithm researchers.`}),(0,Q.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 1.3fr`,gap:`20px`},children:[(0,Q.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`10px`},children:r.map((e,r)=>(0,Q.jsxs)(`div`,{onClick:()=>n(r),className:`glass-panel`,style:{padding:`14px`,cursor:`pointer`,borderColor:t===r?`var(--accent-cyan)`:`var(--border-subtle)`,backgroundColor:t===r?`rgba(0, 240, 255, 0.08)`:`transparent`},children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`,marginBottom:`6px`},children:[(0,Q.jsx)(`span`,{style:{fontSize:`0.75rem`,color:`var(--accent-cyan)`,fontWeight:600},children:e.level}),(0,Q.jsx)(`span`,{style:{fontSize:`0.75rem`,color:`var(--text-muted)`},children:e.duration})]}),(0,Q.jsx)(`h4`,{style:{fontSize:`0.95rem`,fontWeight:700,marginBottom:`8px`},children:e.title}),(0,Q.jsx)(`div`,{style:{height:`4px`,background:`rgba(255,255,255,0.08)`,borderRadius:`4px`,overflow:`hidden`},children:(0,Q.jsx)(`div`,{style:{width:`${e.progress}%`,height:`100%`,background:`linear-gradient(90deg, var(--accent-cyan), var(--accent-purple))`}})})]},r))}),(0,Q.jsxs)(`div`,{className:`glass-panel-glow`,style:{padding:`20px`,display:`flex`,flexDirection:`column`,justifyContent:`space-between`},children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`,marginBottom:`12px`},children:[(0,Q.jsxs)(`span`,{className:`quantum-pill-gold quantum-pill`,children:[i.level,` Track`]}),(0,Q.jsxs)(`span`,{style:{fontFamily:`var(--font-mono)`,fontSize:`0.85rem`,color:`var(--accent-cyan)`},children:[`Progress: `,i.progress,`%`]})]}),(0,Q.jsx)(`h3`,{style:{fontSize:`1.25rem`,fontWeight:700,marginBottom:`10px`},children:i.title}),(0,Q.jsx)(`p`,{style:{fontSize:`0.9rem`,color:`var(--text-secondary)`,marginBottom:`16px`},children:i.description}),(0,Q.jsx)(`div`,{style:{padding:`12px 16px`,borderRadius:`10px`,background:`rgba(0,0,0,0.3)`,border:`1px solid var(--border-glass)`,fontFamily:`var(--font-mono)`,fontSize:`0.85rem`,color:`var(--accent-cyan)`,marginBottom:`16px`,textAlign:`center`},children:i.formula}),(0,Q.jsx)(`h5`,{style:{fontSize:`0.82rem`,textTransform:`uppercase`,letterSpacing:`0.05em`,color:`var(--text-muted)`,marginBottom:`8px`},children:`Key Concepts Covered:`}),(0,Q.jsx)(`div`,{style:{display:`flex`,flexWrap:`wrap`,gap:`6px`},children:i.concepts.map((e,t)=>(0,Q.jsx)(`span`,{style:{fontSize:`0.78rem`,padding:`4px 10px`,borderRadius:`6px`,background:`var(--bg-glass)`,border:`1px solid var(--border-subtle)`},children:e},t))})]}),(0,Q.jsxs)(`div`,{style:{display:`flex`,gap:`10px`,marginTop:`20px`},children:[(0,Q.jsxs)(`button`,{className:`btn-primary`,style:{flex:1,padding:`10px`},onClick:()=>alert(`Starting interactive lesson: ${i.title}`),children:[(0,Q.jsx)(fu,{size:16}),` Continue Learning`]}),(0,Q.jsxs)(`button`,{className:`btn-secondary`,style:{padding:`10px 16px`},onClick:()=>e(`simulation`),children:[(0,Q.jsx)(Ql,{size:16}),` Simulate Circuit`]})]})]})]})]})}function Pu(){let[e,t]=(0,_.useState)(Math.PI/2),[n,r]=(0,_.useState)(0),i=Math.cos(e/2),a=Math.sin(e/2),o=i**2,s=a**2,c=(e,n)=>{t(e),r(n)};return(0,Q.jsxs)(`div`,{children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`10px`,marginBottom:`8px`},children:[(0,Q.jsxs)(`div`,{className:`quantum-pill`,children:[(0,Q.jsx)(Ql,{size:14}),` Quantum Simulation Engine`]}),(0,Q.jsx)(`span`,{style:{fontSize:`0.8rem`,color:`var(--text-muted)`},children:`Bloch Vector & Amplitudes`})]}),(0,Q.jsx)(`h2`,{style:{fontSize:`1.8rem`,fontWeight:800,marginBottom:`6px`},children:`Interactive 1-Qubit Bloch Sphere Simulation`}),(0,Q.jsx)(`p`,{style:{color:`var(--text-secondary)`,marginBottom:`20px`,fontSize:`0.92rem`},children:`Rotate the state vector |ψ⟩ = cos(θ/2)|0⟩ + e^(iφ)sin(θ/2)|1⟩ across the Bloch sphere.`}),(0,Q.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`1.1fr 1fr`,gap:`24px`},children:[(0,Q.jsxs)(`div`,{className:`glass-panel-glow`,style:{padding:`24px`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,minHeight:`300px`,position:`relative`},children:[(0,Q.jsxs)(`div`,{style:{width:`200px`,height:`200px`,borderRadius:`50%`,border:`2px dashed var(--border-glass)`,position:`relative`,display:`flex`,alignItems:`center`,justifyContent:`center`,boxShadow:`inset 0 0 35px rgba(0, 240, 255, 0.15)`},children:[(0,Q.jsx)(`div`,{style:{position:`absolute`,width:`100%`,height:`60px`,borderRadius:`50%`,border:`1px solid rgba(168, 85, 247, 0.4)`,transform:`rotateX(60deg)`}}),(0,Q.jsx)(`span`,{style:{position:`absolute`,top:`-26px`,fontFamily:`var(--font-mono)`,fontWeight:700,color:`var(--accent-cyan)`},children:`|0⟩ (Z+)`}),(0,Q.jsx)(`span`,{style:{position:`absolute`,bottom:`-26px`,fontFamily:`var(--font-mono)`,fontWeight:700,color:`var(--accent-purple)`},children:`|1⟩ (Z-)`}),(0,Q.jsx)(`div`,{style:{position:`absolute`,width:`90px`,height:`3px`,background:`linear-gradient(90deg, transparent, var(--accent-cyan))`,transformOrigin:`0% 50%`,left:`50%`,transform:`rotate(${e-Math.PI/2}rad)`,boxShadow:`0 0 10px var(--accent-cyan)`},children:(0,Q.jsx)(`div`,{style:{position:`absolute`,right:`-6px`,top:`-4px`,width:`10px`,height:`10px`,borderRadius:`50%`,background:`#ffffff`,boxShadow:`0 0 12px var(--accent-cyan)`}})})]}),(0,Q.jsxs)(`div`,{style:{display:`flex`,gap:`8px`,marginTop:`35px`},children:[(0,Q.jsx)(`button`,{className:`btn-secondary`,style:{padding:`6px 12px`,fontSize:`0.8rem`},onClick:()=>c(0,0),children:`Reset |0⟩`}),(0,Q.jsx)(`button`,{className:`btn-secondary`,style:{padding:`6px 12px`,fontSize:`0.8rem`},onClick:()=>c(Math.PI,0),children:`Flip |1⟩`}),(0,Q.jsx)(`button`,{className:`btn-secondary`,style:{padding:`6px 12px`,fontSize:`0.8rem`},onClick:()=>c(Math.PI/2,0),children:`Superposition |+⟩`}),(0,Q.jsx)(`button`,{className:`btn-secondary`,style:{padding:`6px 12px`,fontSize:`0.8rem`},onClick:()=>c(Math.PI/2,Math.PI/2),children:`|+i⟩`})]})]}),(0,Q.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`16px`},children:[(0,Q.jsxs)(`div`,{className:`glass-panel`,style:{padding:`16px`},children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,marginBottom:`8px`},children:[(0,Q.jsx)(`label`,{style:{fontSize:`0.85rem`,fontWeight:600},children:`Polar Angle θ (Superposition):`}),(0,Q.jsxs)(`span`,{style:{fontFamily:`var(--font-mono)`,color:`var(--accent-cyan)`},children:[(e/Math.PI).toFixed(2),`π rad`]})]}),(0,Q.jsx)(`input`,{type:`range`,min:`0`,max:Math.PI,step:`0.01`,value:e,onChange:e=>t(parseFloat(e.target.value)),style:{width:`100%`,accentColor:`var(--accent-cyan)`}}),(0,Q.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,marginTop:`14px`,marginBottom:`8px`},children:[(0,Q.jsx)(`label`,{style:{fontSize:`0.85rem`,fontWeight:600},children:`Azimuthal Angle φ (Relative Phase):`}),(0,Q.jsxs)(`span`,{style:{fontFamily:`var(--font-mono)`,color:`var(--accent-purple)`},children:[(n/Math.PI).toFixed(2),`π rad`]})]}),(0,Q.jsx)(`input`,{type:`range`,min:`0`,max:Math.PI*2,step:`0.01`,value:n,onChange:e=>r(parseFloat(e.target.value)),style:{width:`100%`,accentColor:`var(--accent-purple)`}})]}),(0,Q.jsxs)(`div`,{className:`glass-panel`,style:{padding:`16px`},children:[(0,Q.jsx)(`h4`,{style:{fontSize:`0.9rem`,marginBottom:`12px`},children:`Measurement Probabilities P(x)`}),(0,Q.jsxs)(`div`,{style:{marginBottom:`10px`},children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,fontSize:`0.82rem`,marginBottom:`4px`},children:[(0,Q.jsxs)(`span`,{style:{fontFamily:`var(--font-mono)`,color:`var(--accent-cyan)`},children:[`|0⟩ Amplitude: `,i.toFixed(3)]}),(0,Q.jsxs)(`span`,{style:{fontWeight:600},children:[(o*100).toFixed(1),`%`]})]}),(0,Q.jsx)(`div`,{style:{height:`8px`,background:`rgba(255,255,255,0.08)`,borderRadius:`4px`,overflow:`hidden`},children:(0,Q.jsx)(`div`,{style:{width:`${o*100}%`,height:`100%`,background:`var(--accent-cyan)`,transition:`width 0.15s ease`}})})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,fontSize:`0.82rem`,marginBottom:`4px`},children:[(0,Q.jsxs)(`span`,{style:{fontFamily:`var(--font-mono)`,color:`var(--accent-purple)`},children:[`|1⟩ Amplitude: `,a.toFixed(3)]}),(0,Q.jsxs)(`span`,{style:{fontWeight:600},children:[(s*100).toFixed(1),`%`]})]}),(0,Q.jsx)(`div`,{style:{height:`8px`,background:`rgba(255,255,255,0.08)`,borderRadius:`4px`,overflow:`hidden`},children:(0,Q.jsx)(`div`,{style:{width:`${s*100}%`,height:`100%`,background:`var(--accent-purple)`,transition:`width 0.15s ease`}})})]})]})]})]})]})}function Fu(){let[e,t]=(0,_.useState)([{wire:0,gates:[`H`,`•`,``]},{wire:1,gates:[``,`⊕`,``]},{wire:2,gates:[``,``,`X`]}]),[n,r]=(0,_.useState)(null),i=[{name:`H`,desc:`Hadamard (Superposition)`},{name:`X`,desc:`Pauli-X (NOT Gate)`},{name:`Z`,desc:`Pauli-Z (Phase Flip)`},{name:`•`,desc:`Control Node`},{name:`⊕`,desc:`Target (CNOT)`},{name:`M`,desc:`Measurement`}],a=(e,n)=>{t(t=>{let r=JSON.parse(JSON.stringify(t));return r[e].gates.push(n),r})};return(0,Q.jsxs)(`div`,{children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`10px`,marginBottom:`8px`},children:[(0,Q.jsxs)(`div`,{className:`quantum-pill`,children:[(0,Q.jsx)(nu,{size:14}),` Quantum Circuit Composer`]}),(0,Q.jsx)(`span`,{style:{fontSize:`0.8rem`,color:`var(--text-muted)`},children:`Multi-Qubit Entanglement Engine`})]}),(0,Q.jsx)(`h2`,{style:{fontSize:`1.8rem`,fontWeight:800,marginBottom:`6px`},children:`Visual Quantum Algorithm Circuit Board`}),(0,Q.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`,flexWrap:`wrap`,gap:`12px`,marginBottom:`18px`},children:[(0,Q.jsx)(`p`,{style:{color:`var(--text-secondary)`,margin:0,fontSize:`0.92rem`},children:`Compose quantum circuits with unitary quantum gates and execute statevector simulations.`}),(0,Q.jsxs)(`button`,{onClick:()=>{window.location.href=`/simulator/index.html`},className:`btn-primary`,style:{padding:`10px 20px`,fontSize:`0.92rem`,borderRadius:`10px`},children:[(0,Q.jsx)(nu,{size:16}),(0,Q.jsx)(`span`,{children:`Open Full Circuit Builder →`})]})]}),(0,Q.jsxs)(`div`,{className:`glass-panel`,style:{padding:`12px 18px`,display:`flex`,alignItems:`center`,gap:`12px`,marginBottom:`20px`},children:[(0,Q.jsx)(`span`,{style:{fontSize:`0.85rem`,fontWeight:600,color:`var(--text-muted)`},children:`Gate Library:`}),(0,Q.jsx)(`div`,{style:{display:`flex`,gap:`8px`,flexWrap:`wrap`},children:i.map(e=>(0,Q.jsx)(`button`,{title:e.desc,onClick:()=>a(0,e.name),style:{width:`36px`,height:`36px`,borderRadius:`8px`,background:`rgba(0, 240, 255, 0.1)`,border:`1px solid var(--border-glass)`,color:`var(--accent-cyan)`,fontFamily:`var(--font-mono)`,fontWeight:700,fontSize:`0.9rem`},children:e.name},e.name))}),(0,Q.jsx)(`span`,{style:{fontSize:`0.75rem`,color:`var(--text-muted)`,marginLeft:`auto`},children:`Click gate to append to q[0]`})]}),(0,Q.jsx)(`div`,{className:`glass-panel-glow`,style:{padding:`24px`,marginBottom:`20px`,display:`flex`,flexDirection:`column`,gap:`24px`},children:e.map((e,t)=>(0,Q.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`16px`},children:[(0,Q.jsxs)(`span`,{style:{fontFamily:`var(--font-mono)`,fontWeight:700,fontSize:`0.9rem`,width:`45px`,color:`var(--accent-cyan)`},children:[`q[`,t,`]`]}),(0,Q.jsx)(`div`,{style:{flex:1,height:`2px`,background:`rgba(255,255,255,0.2)`,position:`relative`,display:`flex`,alignItems:`center`,gap:`24px`,paddingLeft:`20px`},children:e.gates.map((e,t)=>(0,Q.jsx)(`div`,{style:{width:`36px`,height:`36px`,borderRadius:`8px`,background:e?`var(--bg-glass-hover)`:`transparent`,border:e?`1px solid var(--accent-cyan)`:`none`,display:`flex`,alignItems:`center`,justifyContent:`center`,fontFamily:`var(--font-mono)`,fontWeight:800,color:e===`•`?`var(--accent-cyan)`:e===`⊕`?`var(--accent-purple)`:`var(--text-bright)`,boxShadow:e?`0 0 10px rgba(0,240,255,0.25)`:`none`},children:e},t))}),(0,Q.jsx)(`button`,{className:`btn-secondary`,style:{padding:`4px 8px`,fontSize:`0.75rem`},onClick:()=>a(t,`H`),children:`+H`}),(0,Q.jsx)(`button`,{className:`btn-secondary`,style:{padding:`4px 8px`,fontSize:`0.75rem`},onClick:()=>a(t,`X`),children:`+X`})]},t))}),(0,Q.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`},children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,gap:`10px`},children:[(0,Q.jsxs)(`button`,{className:`btn-primary`,onClick:()=>{r({shots:1024,counts:{"|000⟩":508,"|110⟩":516},fidelity:`99.82%`,executionTime:`12.4 ms`})},children:[(0,Q.jsx)(fu,{size:16}),` Run 1024 Q-Shots`]}),(0,Q.jsxs)(`button`,{className:`btn-secondary`,onClick:()=>{t([{wire:0,gates:[]},{wire:1,gates:[]},{wire:2,gates:[]}]),r(null)},children:[(0,Q.jsx)(mu,{size:16}),` Reset Wires`]})]}),n&&(0,Q.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`16px`,fontFamily:`var(--font-mono)`,fontSize:`0.85rem`},children:[(0,Q.jsxs)(`span`,{style:{color:`var(--accent-emerald)`},children:[`✓ Coherence: `,n.fidelity]}),(0,Q.jsxs)(`span`,{style:{color:`var(--accent-cyan)`},children:[`|000⟩: `,n.counts[`|000⟩`]]}),(0,Q.jsxs)(`span`,{style:{color:`var(--accent-purple)`},children:[`|110⟩: `,n.counts[`|110⟩`]]})]})]})]})}function Iu(){let[e,t]=(0,_.useState)([{role:`assistant`,text:`Greetings, Quantum Explorer! I am Q-Copilot, your AI quantum physics tutor. How can I assist your algorithm design or theory today?`,code:`# Bell State Entanglement Example
from qiskit import QuantumCircuit
qc = QuantumCircuit(2)
qc.h(0)         # Put qubit 0 into superposition
qc.cx(0, 1)     # Entangle qubit 0 and 1 into Bell state |Φ+⟩`}]),[n,r]=(0,_.useState)(``),i=[`Explain how Grover’s amplitude amplification works`,`What is the difference between T1 and T2 coherence time?`,`Show me how to construct a Quantum Teleportation circuit`],a=e=>{let i=e||n;if(!i.trim())return;let a={role:`user`,text:i};t(e=>[...e,a]),r(``),setTimeout(()=>{t(e=>[...e,{role:`assistant`,text:`Insight on "${i}": In quantum computing, constructive interference amplifies probability amplitudes of the correct eigenstate, while destructive interference cancels erroneous paths.`,code:`# Qiskit Optimization
# Running simulated statevector analysis...
statevector = backend.run(transpiled_circuit).result().get_statevector()
print("Circuit depth minimized to 4 gates")`}])},700)};return(0,Q.jsxs)(`div`,{children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`10px`,marginBottom:`8px`},children:[(0,Q.jsxs)(`div`,{className:`quantum-pill`,style:{borderColor:`rgba(168,85,247,0.4)`,color:`var(--accent-purple)`},children:[(0,Q.jsx)(bu,{size:14}),` AI Quantum Copilot v4.2`]}),(0,Q.jsx)(`span`,{style:{fontSize:`0.8rem`,color:`var(--text-muted)`},children:`Fine-Tuned on Qiskit & PennyLane`})]}),(0,Q.jsx)(`h2`,{style:{fontSize:`1.8rem`,fontWeight:800,marginBottom:`6px`},children:`AI Quantum Algorithmic Tutor`}),(0,Q.jsx)(`p`,{style:{color:`var(--text-secondary)`,marginBottom:`16px`,fontSize:`0.92rem`},children:`Ask any questions on quantum gates, error correction, Hamiltonian simulations, or algorithm optimization.`}),(0,Q.jsx)(`div`,{style:{display:`flex`,gap:`8px`,flexWrap:`wrap`,marginBottom:`16px`},children:i.map((e,t)=>(0,Q.jsxs)(`button`,{onClick:()=>a(e),style:{padding:`6px 12px`,borderRadius:`8px`,fontSize:`0.78rem`,background:`var(--bg-glass)`,border:`1px solid var(--border-subtle)`,color:`var(--text-secondary)`,textAlign:`left`},children:[`"`,e,`"`]},t))}),(0,Q.jsx)(`div`,{className:`glass-panel`,style:{height:`280px`,overflowY:`auto`,padding:`16px`,marginBottom:`16px`,display:`flex`,flexDirection:`column`,gap:`14px`},children:e.map((e,t)=>(0,Q.jsxs)(`div`,{style:{alignSelf:e.role===`user`?`flex-end`:`flex-start`,maxWidth:`85%`,background:e.role===`user`?`rgba(0, 240, 255, 0.15)`:`rgba(255, 255, 255, 0.05)`,border:e.role===`user`?`1px solid var(--border-glass)`:`1px solid var(--border-subtle)`,borderRadius:`12px`,padding:`12px 16px`},children:[(0,Q.jsx)(`div`,{style:{fontSize:`0.75rem`,fontWeight:700,color:e.role===`user`?`var(--accent-cyan)`:`var(--accent-purple)`,marginBottom:`4px`},children:e.role===`user`?`You`:`Q-Copilot AI`}),(0,Q.jsx)(`div`,{style:{fontSize:`0.9rem`,lineHeight:1.5},children:e.text}),e.code&&(0,Q.jsx)(`pre`,{style:{marginTop:`10px`,padding:`10px`,background:`rgba(0,0,0,0.4)`,borderRadius:`8px`,fontFamily:`var(--font-mono)`,fontSize:`0.78rem`,color:`var(--accent-cyan)`,overflowX:`auto`},children:e.code})]},t))}),(0,Q.jsxs)(`div`,{style:{display:`flex`,gap:`10px`},children:[(0,Q.jsx)(`input`,{type:`text`,placeholder:`Ask a quantum mechanics or algorithm question...`,value:n,onChange:e=>r(e.target.value),onKeyDown:e=>e.key===`Enter`&&a(),style:{flex:1,padding:`12px 16px`,borderRadius:`12px`,background:`var(--bg-glass)`,border:`1px solid var(--border-glass)`,color:`var(--text-primary)`}}),(0,Q.jsxs)(`button`,{className:`btn-primary`,onClick:()=>a(),children:[(0,Q.jsx)(vu,{size:16}),` Send`]})]})]})}function Lu(){let[e,t]=(0,_.useState)(null),[n,r]=(0,_.useState)(!1),i={title:`Quantum State Evolution & Circuit Equivalence`,text:`A qubit is initialized in state |0⟩. A Hadamard gate (H) is applied, followed immediately by another Hadamard gate (H). What is the final state of the qubit?`,options:[{id:`A`,label:`|+⟩ = 1/√2 (|0⟩ + |1⟩)`,correct:!1},{id:`B`,label:`|0⟩ (H is its own hermitian inverse: H² = I)`,correct:!0},{id:`C`,label:`|1⟩ (Bit flip)`,correct:!1},{id:`D`,label:`Superposition with phase π`,correct:!1}],explanation:`The Hadamard gate is unitary and self-inverse: H · H = H² = I (the Identity operator). Applying it twice restores the exact initial state |0⟩.`},a=e=>{n||t(e)};return(0,Q.jsxs)(`div`,{children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`10px`,marginBottom:`8px`},children:[(0,Q.jsxs)(`div`,{className:`quantum-pill`,children:[(0,Q.jsx)(Hl,{size:14}),` Knowledge Benchmark`]}),(0,Q.jsx)(`span`,{style:{fontSize:`0.8rem`,color:`var(--text-muted)`},children:`Adaptive Assessment Level 1`})]}),(0,Q.jsx)(`h2`,{style:{fontSize:`1.8rem`,fontWeight:800,marginBottom:`6px`},children:i.title}),(0,Q.jsx)(`p`,{style:{color:`var(--text-secondary)`,marginBottom:`20px`,fontSize:`0.95rem`},children:i.text}),(0,Q.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`10px`,marginBottom:`20px`},children:i.options.map(t=>{let r=`var(--bg-glass)`,i=`var(--border-subtle)`;return e===t.id&&(i=`var(--accent-cyan)`,r=`rgba(0, 240, 255, 0.1)`),n&&(t.correct?(i=`var(--accent-emerald)`,r=`rgba(16, 185, 129, 0.15)`):e===t.id&&!t.correct&&(i=`#ef4444`,r=`rgba(239, 68, 68, 0.15)`)),(0,Q.jsxs)(`div`,{onClick:()=>a(t.id),style:{padding:`14px 18px`,borderRadius:`12px`,border:`1px solid ${i}`,backgroundColor:r,cursor:n?`default`:`pointer`,display:`flex`,alignItems:`center`,gap:`12px`,transition:`var(--transition-smooth)`},children:[(0,Q.jsx)(`div`,{style:{width:`28px`,height:`28px`,borderRadius:`50%`,display:`flex`,alignItems:`center`,justifyContent:`center`,border:`1px solid var(--border-glass)`,fontWeight:700,fontSize:`0.85rem`},children:t.id}),(0,Q.jsx)(`div`,{style:{fontFamily:`var(--font-mono)`,fontSize:`0.9rem`},children:t.label})]},t.id)})}),n&&(0,Q.jsxs)(`div`,{className:`glass-panel`,style:{padding:`16px`,marginBottom:`20px`,borderColor:e===`B`?`var(--accent-emerald)`:`#ef4444`},children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`8px`,marginBottom:`6px`,fontWeight:700},children:[(0,Q.jsx)(Xl,{size:18,color:`var(--accent-emerald)`}),(0,Q.jsx)(`span`,{children:`Explanation:`})]}),(0,Q.jsx)(`p`,{style:{fontSize:`0.88rem`,color:`var(--text-secondary)`},children:i.explanation})]}),(0,Q.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`},children:[(0,Q.jsx)(`span`,{style:{fontSize:`0.85rem`,color:`var(--text-muted)`},children:`Question 1 of 10 • Pass mark 80%`}),(0,Q.jsx)(`button`,{className:`btn-primary`,onClick:()=>{n?(r(!1),t(null)):r(!0)},children:n?`Next Question`:`Submit Answer`})]})]})}function Ru({initialMode:e,onClose:t}){let[n,r]=(0,_.useState)(e||`signin`),[i,a]=(0,_.useState)(!1),o=e=>{e.preventDefault(),a(!0),setTimeout(()=>{t()},1200)};return(0,Q.jsxs)(`div`,{children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,borderBottom:`1px solid var(--border-subtle)`,marginBottom:`24px`,paddingBottom:`10px`,gap:`20px`},children:[(0,Q.jsx)(`button`,{onClick:()=>r(`signin`),style:{fontSize:`1.1rem`,fontWeight:700,color:n===`signin`?`var(--accent-cyan)`:`var(--text-muted)`,borderBottom:n===`signin`?`2px solid var(--accent-cyan)`:`none`,paddingBottom:`6px`},children:`Sign In`}),(0,Q.jsx)(`button`,{onClick:()=>r(`signup`),style:{fontSize:`1.1rem`,fontWeight:700,color:n===`signup`?`var(--accent-cyan)`:`var(--text-muted)`,borderBottom:n===`signup`?`2px solid var(--accent-cyan)`:`none`,paddingBottom:`6px`},children:`Create Account`})]}),i?(0,Q.jsxs)(`div`,{style:{textAlign:`center`,padding:`30px 0`},children:[(0,Q.jsx)(Xl,{size:48,color:`var(--accent-cyan)`,style:{marginBottom:`16px`}}),(0,Q.jsx)(`h3`,{style:{fontSize:`1.3rem`,fontWeight:700,marginBottom:`8px`},children:`Quantum Access Granted`}),(0,Q.jsx)(`p`,{style:{color:`var(--text-muted)`,fontSize:`0.9rem`},children:`Connecting your cryptographic state to the QNova quantum cloud...`})]}):(0,Q.jsxs)(`form`,{onSubmit:o,style:{display:`flex`,flexDirection:`column`,gap:`16px`},children:[n===`signup`&&(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`label`,{style:{display:`block`,fontSize:`0.82rem`,marginBottom:`6px`,color:`var(--text-muted)`},children:`Full Name or Quantum Handle`}),(0,Q.jsx)(`input`,{type:`text`,placeholder:`Dr. Richard Feynman`,required:!0,style:{width:`100%`,padding:`12px 14px`,borderRadius:`10px`,background:`var(--bg-glass)`,border:`1px solid var(--border-subtle)`,color:`var(--text-primary)`}})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`label`,{style:{display:`block`,fontSize:`0.82rem`,marginBottom:`6px`,color:`var(--text-muted)`},children:`Lab Email Address`}),(0,Q.jsx)(`input`,{type:`email`,placeholder:`researcher@quantum.org`,required:!0,style:{width:`100%`,padding:`12px 14px`,borderRadius:`10px`,background:`var(--bg-glass)`,border:`1px solid var(--border-subtle)`,color:`var(--text-primary)`}})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`label`,{style:{display:`block`,fontSize:`0.82rem`,marginBottom:`6px`,color:`var(--text-muted)`},children:`Quantum Key Password`}),(0,Q.jsx)(`input`,{type:`password`,placeholder:`••••••••••••`,required:!0,style:{width:`100%`,padding:`12px 14px`,borderRadius:`10px`,background:`var(--bg-glass)`,border:`1px solid var(--border-subtle)`,color:`var(--text-primary)`}})]}),(0,Q.jsxs)(`button`,{type:`submit`,className:`btn-primary`,style:{width:`100%`,marginTop:`8px`,padding:`12px`},children:[n===`signin`?(0,Q.jsx)(ou,{size:16}):(0,Q.jsx)(Ou,{size:16}),(0,Q.jsx)(`span`,{children:n===`signin`?`Sign In to Quantum Lab`:`Create Free Student Account`})]}),(0,Q.jsx)(`div`,{style:{textAlign:`center`,fontSize:`0.8rem`,color:`var(--text-muted)`,margin:`8px 0`},children:`or connect with`}),(0,Q.jsxs)(`div`,{style:{display:`flex`,gap:`10px`},children:[(0,Q.jsx)(`button`,{type:`button`,className:`btn-secondary`,style:{flex:1,padding:`10px`,fontSize:`0.85rem`},onClick:()=>o({preventDefault:()=>{}}),children:`GitHub SSO`}),(0,Q.jsx)(`button`,{type:`button`,className:`btn-secondary`,style:{flex:1,padding:`10px`,fontSize:`0.85rem`},onClick:()=>o({preventDefault:()=>{}}),children:`Google Academic`})]})]})]})}function zu({openModal:e}){return(0,Q.jsxs)(`footer`,{style:{position:`relative`,zIndex:10,borderTop:`1px solid var(--border-subtle)`,background:`var(--bg-card)`,backdropFilter:`blur(20px)`,padding:`50px 24px 30px`,color:`var(--text-secondary)`},children:[(0,Q.jsxs)(`div`,{style:{maxWidth:`1280px`,margin:`0 auto`,display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(220px, 1fr))`,gap:`40px`,marginBottom:`40px`},children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`10px`,marginBottom:`14px`},children:[(0,Q.jsx)(`div`,{className:`qnova-logo-container`,style:{width:`42px`,height:`42px`,borderRadius:`12px`,flexShrink:0},children:(0,Q.jsx)(`img`,{src:`/qnova-logo.png`,alt:`QNova Logo`,className:`qnova-logo-img`})}),(0,Q.jsx)(`span`,{style:{fontFamily:`var(--font-tech)`,fontSize:`1.25rem`,fontWeight:800,color:`var(--text-bright)`},children:`QNova`})]}),(0,Q.jsx)(`p`,{style:{fontSize:`0.85rem`,lineHeight:1.6,marginBottom:`16px`},children:`Empowering the next generation of quantum researchers, physicists, and software engineers with AI-driven circuit exploration and real-time noise simulation.`}),(0,Q.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`8px`,fontSize:`0.78rem`,color:`var(--accent-emerald)`},children:[(0,Q.jsx)(`span`,{style:{width:`8px`,height:`8px`,borderRadius:`50%`,background:`var(--accent-emerald)`,boxShadow:`0 0 8px var(--accent-emerald)`}}),(0,Q.jsx)(`span`,{children:`Novera QPU Cloud: Operational (127 Qubits)`})]})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`h4`,{style:{fontSize:`0.9rem`,fontWeight:700,color:`var(--text-bright)`,marginBottom:`16px`},children:`Platform Modules`}),(0,Q.jsxs)(`ul`,{style:{listStyle:`none`,display:`flex`,flexDirection:`column`,gap:`10px`,fontSize:`0.85rem`},children:[(0,Q.jsx)(`li`,{children:(0,Q.jsx)(`a`,{href:`#learning`,onClick:t=>{t.preventDefault(),e(`learning`)},style:{color:`inherit`,textDecoration:`none`},children:`Quantum Algorithm Roadmap`})}),(0,Q.jsx)(`li`,{children:(0,Q.jsx)(`a`,{href:`#simulation`,onClick:t=>{t.preventDefault(),e(`simulation`)},style:{color:`inherit`,textDecoration:`none`},children:`Bloch Sphere & Statevector Sim`})}),(0,Q.jsx)(`li`,{children:(0,Q.jsx)(`a`,{href:`#composer`,onClick:t=>{t.preventDefault(),e(`composer`)},style:{color:`inherit`,textDecoration:`none`},children:`Multi-Qubit Circuit Composer`})}),(0,Q.jsx)(`li`,{children:(0,Q.jsx)(`a`,{href:`#tutor`,onClick:t=>{t.preventDefault(),e(`tutor`)},style:{color:`inherit`,textDecoration:`none`},children:`Q-Copilot AI Physicist`})}),(0,Q.jsx)(`li`,{children:(0,Q.jsx)(`a`,{href:`#assessment`,onClick:t=>{t.preventDefault(),e(`assessment`)},style:{color:`inherit`,textDecoration:`none`},children:`Adaptive Assessment Engine`})})]})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`h4`,{style:{fontSize:`0.9rem`,fontWeight:700,color:`var(--text-bright)`,marginBottom:`16px`},children:`SDK Transpilers`}),(0,Q.jsxs)(`ul`,{style:{listStyle:`none`,display:`flex`,flexDirection:`column`,gap:`10px`,fontSize:`0.85rem`},children:[(0,Q.jsx)(`li`,{children:`IBM Qiskit 1.0 Runtime`}),(0,Q.jsx)(`li`,{children:`Google Cirq Framework`}),(0,Q.jsx)(`li`,{children:`Xanadu PennyLane QML`}),(0,Q.jsx)(`li`,{children:`Rigetti Quil-T Pulse Level`}),(0,Q.jsx)(`li`,{children:`OpenQASM 3.0 Standard`})]})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`h4`,{style:{fontSize:`0.9rem`,fontWeight:700,color:`var(--text-bright)`,marginBottom:`16px`},children:`Hardware Specs`}),(0,Q.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`8px`,fontSize:`0.82rem`,fontFamily:`var(--font-mono)`},children:[(0,Q.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`},children:[(0,Q.jsx)(`span`,{children:`Base Temperature:`}),(0,Q.jsx)(`span`,{style:{color:`var(--accent-cyan)`},children:`11.4 mK`})]}),(0,Q.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`},children:[(0,Q.jsx)(`span`,{children:`Average T₁:`}),(0,Q.jsx)(`span`,{style:{color:`var(--accent-gold)`},children:`192.4 μs`})]}),(0,Q.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`},children:[(0,Q.jsx)(`span`,{children:`1-Qubit Gate Error:`}),(0,Q.jsx)(`span`,{style:{color:`var(--accent-emerald)`},children:`0.04%`})]}),(0,Q.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`},children:[(0,Q.jsx)(`span`,{children:`2-Qubit Gate Error:`}),(0,Q.jsx)(`span`,{style:{color:`var(--accent-emerald)`},children:`0.13%`})]}),(0,Q.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`},children:[(0,Q.jsx)(`span`,{children:`Readout Fidelity:`}),(0,Q.jsx)(`span`,{style:{color:`var(--accent-cyan)`},children:`98.9%`})]})]})]})]}),(0,Q.jsxs)(`div`,{style:{maxWidth:`1280px`,margin:`0 auto`,paddingTop:`24px`,borderTop:`1px solid var(--border-subtle)`,display:`flex`,flexWrap:`wrap`,justifyContent:`space-between`,alignItems:`center`,gap:`12px`,fontSize:`0.8rem`},children:[(0,Q.jsx)(`div`,{children:`© 2026 QNova Quantum Lab. Designed for Next-Gen Quantum Algorithm Education & Research.`}),(0,Q.jsxs)(`div`,{style:{display:`flex`,gap:`20px`},children:[(0,Q.jsx)(`span`,{children:`Privacy Architecture`}),(0,Q.jsx)(`span`,{children:`Security Protocol`}),(0,Q.jsx)(`span`,{children:`Quantum Open Source`})]})]})]})}function Bu(){let[e,t]=(0,_.useState)(`dark`),[n,r]=(0,_.useState)(`home`),[i,a]=(0,_.useState)(null);(0,_.useEffect)(()=>{document.documentElement.setAttribute(`data-theme`,e)},[e]),(0,_.useEffect)(()=>{let e=e=>{e.key===`Escape`&&a(null)};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[]);let o=()=>{t(e=>e===`dark`?`light`:`dark`)},s=e=>{a(e),[`learning`,`simulation`,`composer`,`tutor`,`assessment`].includes(e)&&r(e)};return(0,Q.jsxs)(`div`,{style:{position:`relative`,minHeight:`100vh`},children:[(0,Q.jsx)(Tl,{theme:e}),(0,Q.jsx)(ku,{theme:e,toggleTheme:o,activeTab:n,setActiveTab:r,openModal:s}),(0,Q.jsxs)(`main`,{children:[(0,Q.jsx)(Au,{openModal:s}),(0,Q.jsx)(ju,{openModal:s})]}),(0,Q.jsx)(zu,{openModal:s}),(0,Q.jsx)(Mu,{type:i,onClose:()=>{a(null)},onNavigate:e=>s(e)})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,Q.jsx)(_.StrictMode,{children:(0,Q.jsx)(Bu,{})}));